...
const UserIcon = () => {
  const {ConfirmDialog:LogOutConfirmDialog,Confirmation:logOutConfirmation} = useConfirm({title:"Are you sure that you want to log out?",message:"You'd need to Sign in again in order to access your workspaces"})
