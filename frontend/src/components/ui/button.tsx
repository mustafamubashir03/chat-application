...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none   aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        primary:
          'px-6 py-3 rounded-[8px] font-medium text-white bg-gradient-to-r from-blue-500  to-blue-400 border border-blue-400 shadow-lg shadow-blue-500/50 transition duration-300 hover:shadow-md cursor-pointer',
        ...
        indigoGlow:
          'bg-indigo-800/40 text-indigo-300 hover:bg-indigo-900/60 hover:text-indigo-200 active:bg-indigo-800/40 shadow-sm border border-indigo-800/40 cursor-pointer',
        BlueDark:
