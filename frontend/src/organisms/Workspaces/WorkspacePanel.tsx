  ...
  if (isSuccess) {
    return (
      <div className="text-slate-300 flex flex-col h-full">
        ...
        <WorkspacePanelSection label='Personal' openState={openPersonalState} setOpenState={setOpenPersonalState}>
        ...
        <WorkspacePanelSection label='Channels' openState={openChannelPanelSection} setOpenState={setOpenChannelPanelSection}>
